...
[![Quality Gate][sonar-gate-img]][sonar-gate-url] `product-name` passes SonarCloud's quality gate.
...
[blocker_violations-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=blocker_violations
[blocker_violations-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[bugs-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=bugs
[bugs-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[code_smells-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=code_smells
[code_smells-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[comment_lines_density-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=comment_lines_density
[comment_lines_density-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[coverage-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=coverage
[coverage-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[critical_violations-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=critical_violations
[critical_violations-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[duplicated_lines_density-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=duplicated_lines_density
[duplicated_lines_density-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[function_complexity-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=function_complexity
[function_complexity-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[gregswindle-url]: https://github.com/gregswindle
[it_coverage-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=it_coverage
[it_coverage-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[license-url]: https://www.apache.org/licenses/LICENSE-2.0
[lines-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=lines
[lines-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[ncloc-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=ncloc
[ncloc-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[new_blocker_violations-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=new_blocker_violations
[new_blocker_violations-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[new_bugs-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=new_bugs
[new_bugs-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[new_code_smells-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=new_code_smells
[new_code_smells-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[new_coverage-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=new_coverage
[new_coverage-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[new_critical_violations-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=new_critical_violations
[new_critical_violations-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[new_duplicated_lines_density-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=new_duplicated_lines_density
[new_duplicated_lines_density-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[new_it_coverage-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=new_it_coverage
[new_it_coverage-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[new_maintainability_rating-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=new_maintainability_rating
[new_maintainability_rating-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[new_overall_coverage-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=new_overall_coverage
[new_overall_coverage-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[new_reliability_rating-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=new_reliability_rating
[new_reliability_rating-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[new_security_rating-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=new_security_rating
[new_security_rating-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[new_sqale_debt_ratio-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=new_sqale_debt_ratio
[new_sqale_debt_ratio-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[new_vulnerabilities-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=new_vulnerabilities
[new_vulnerabilities-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[overall_coverage-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=overall_coverage
[overall_coverage-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[public_documented_api_density-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=public_documented_api_density
[public_documented_api_density-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[skipped_tests-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=skipped_tests
[skipped_tests-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
...
[sqale_debt_ratio-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=sqale_debt_ratio
[sqale_debt_ratio-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[test_errors-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=test_errors
[test_errors-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[test_failures-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=test_failures
[test_failures-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[test_success_density-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=test_success_density
[test_success_density-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
[vulnerabilities-image]: http://sonarcloud.io/api/badges/measure?key=gregswindle-product-name&metric=vulnerabilities
[vulnerabilities-url]: https://sonarcloud.io/component_measures?id=gregswindle-product-name
